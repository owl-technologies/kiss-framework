...
export { Constructor, ConstructorOrFunction, Delta, GatewayFn, IdSearchConfiguration, NameSearchConfiguration, TransformableLink as OpLink, SearchableById, SearchableByName } from "./kiss-data/decorators/types.js";
